...
import 'package:car2godriver/models/exceptions/internet_connection.dart';
import 'package:car2godriver/models/exceptions/response_status_code.dart';
...
class APIHelper {
  ...
  static String toServerDateTimeFormattedStringFromDateTime(
          DateTime dateTime) =>
      AppComponents.apiDateTimeFormat.format(dateTime.toUtc());
